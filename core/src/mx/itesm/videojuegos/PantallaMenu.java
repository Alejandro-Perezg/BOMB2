...
class PantallaMenu implements Screen {
    ...
    private void crearHUD() {
        ...
        //Boton jugar
        TextureRegionDrawable trdJuegar = new TextureRegionDrawable(new TextureRegion(new Texture("back.png")));
        TextureRegionDrawable trdJugarPressed = new TextureRegionDrawable(new TextureRegion(new Texture("backPressed.png")));

        final ImageButton btnBack = new ImageButton(trdJuegar,trdJugarPressed);
        ...
        btnBack.addListener(new ClickListener(){
                                ...
                                public void clicked(InputEvent event, float x, float y) {
                                    ...
                                    //INSTRUCCIONE
                                    juego.setScreen(new PantallaSeleecionPersonaje(juego));
                                }
                            }
        );
